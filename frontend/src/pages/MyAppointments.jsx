        ...
        {doctors.slice(0,2).map((item , index)=>(
          <div className='grid grid-cols-[1fr_2fr]gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='mt-1 text-sm'><span className='text-sm font-medium text-neutral-700'>Date & Time:</span> 25, July, 2024 | 8.30 PM</p>
            </div>
            ...
            <div className='flex flex-col justify-end gap-2'>
              ...
              <button className='py-2 text-sm text-center border rounded text-stone-500 sm:min-w-48 hover:bg-red-600 hover:text-white' >Cancel Appointment</button>
            </div>
          </div>
        ))}
      </div>
